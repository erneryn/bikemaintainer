...
const AddNewModal = (props) => {
  ...
  const [validationBrand, setValidationBrand] = useState(true);
  const [file, setFile] = useState(null);
  const [frame,setFrame] = useState(null)
  const [drivetrain,setDrivetrain] = useState({})
  const [cockpit,setCokcpit] = useState({})
  ...
  const onChangeDrivetrain = (e,key)=>{
    e.preventDefault()
    let obj = drivetrain
  ...
  return (
    <div>
      ...
      <div className="fixed z-50 inset-0 flex justify-center items-center">
        <div className="bg-gray-500 w-10/12 h-screen py-6 rounded-3xl flex items-center justify-start flex-col relative">
          <button
          ...
          <div className="w-full px-16">
            ...
            <div className="w-full h-2/6 px-4 bg-gray-400 pt-2 rounded-xl mr-5 mt-2">
              <h1 className="font-medium text-xl mb-5">Bike Specification:</h1>
